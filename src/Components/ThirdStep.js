      ...
      <div className="row">
        <div className="col-md-6 travel-form">
          ...
          <input
            ...
            onChange={(e) =>
              setUserData({ ...userData, beniciaryname: e.target.value })
            }
            name="benificary"
            className="w-100 input-field mb-3"
        ...
        <div className="col-md-6 travel-form">
          ...
          <input
            ...
            onChange={(e) =>
              setUserData({ ...userData, benificaryaddress: e.target.value })
            }
            name="date"
            className="w-100 input-field mb-3"
...
function Firstchild({ userData, setUserData }) {
  return (
    <>
...
function Secondchild({ userData, setUserData }) {
  return (
    <>
      {/* Second Child */}
      <div className="row">
...
function Thirdchild({ userData, setUserData }) {
  return (
    <>
      {/* Third Child */}
