                ...
                <div className="col-md-6 travel-form">
                    ...
                    <div className="d-flex">
                        <label className="chkbox">
                            ...
                            name="radio" 
                            value= "single"
                            checked={userData['single']}
                            onChange={(e) => setUserData({ ...userData, "single": e.target.value })}
                        />
                        ...
                        <label className="chkbox ml-4">
                            ...
                            name="radio" 
                            value="Annual"
                            checked={userData['annual']} 
                            onChange={(e) => setUserData({ ...userData, "annual": e.target.value })}
                        />
                            <span className="checkmark"></span>
                        </label>
                    </div>
            ...
            <div className="row">
                <div className="col-md-6 travel-form">
                    ...
                    <select
                        ...
                        onChange={(e) => setUserData({ ...userData, "purposeOfVist": e.target.value })}
                ...
                <div className="col-md-6 travel-form">
                    ...
                    <input
                        ...
                        onChange={(e) => setUserData({ ...userData, "passportNumber": e.target.value })}
                        name="passportnumber"
                        className="w-100 input-field mb-3"
              ...
              <div className="d-flex">
                <label className="chkbox">
                  ...
                  <input 
                    ...
                    onChange={(e) => setUserData({ ...userData, "covidUnc" : e.target.value})}
                />
                  <span className="checkmark"></span>
                </label>
                <label className="chkbox ml-4">
                  ...
                  <input 
                    ...
                    onChange={(e) => setUserData({ ...userData, "covid" : e.target.value})}
                />
                  <span className="checkmark"></span>
                </label>
              </div>
              ...
              <div className="d-flex">
                <label className="chkbox">
                  ...
                  <input 
                    ...
                    onChange={(e) => setUserData({ ...userData, "singleTrip" : e.target.value})}
                />
                  <span className="checkmark"></span>
                </label>
                <label className="chkbox ml-4">
                  ...
                  <input 
                    ...
                    onChange={(e) => setUserData({ ...userData, "familyTrip" : e.target.value})} 
                />
                  <span className="checkmark"></span>
                </label>
              </div>
